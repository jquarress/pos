...
<div class="right" style="overflow-y:auto">
		<div class="centered">
<div class ="container-flui padding">
	<div class="row welcome text-center">
		...
		<div class="col-md-12">
			<div class="box">
				<i class="far fa-handshake" style='font-size:48px;color:rgb(53, 151, 14)'></i>
		...
		<div class="col-md-12">
			<div class="box2">
				<i class="far fa-smile" style='font-size:48px;color:rgb(53, 151, 14)' height=50></i>
				<p>Discussion:</p>
				<p><b>The deal for the day!</b></p>
				<p><b></b></p>
				<p><b>6g's on the first eighth!</b></p>
				<p><b>or 30% off one item!</b></p>
			</div>
		</div>
	</div>
</div>
